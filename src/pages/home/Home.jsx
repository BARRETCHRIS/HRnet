    ...
    return (
        <main className="wrapper">
            <section className="home">
                ...
                <article className='home_actions'>
                    <Link className='home_actions_btn' to='/create'>Create Employee</Link>
                    <Link className='home_actions_btn' to='/list'>View list Employee</Link>
                </article>
            </section>
        </main>
    );
